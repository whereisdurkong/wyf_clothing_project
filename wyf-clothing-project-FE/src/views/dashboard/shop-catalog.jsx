...
function hasVariants(product) {
    return product.has_variants === true || product.has_variants === 'true' || product.has_variants === '1' || product.has_variants === 1;
}
            ...
            <div className="na-img-wrap">
                ...
                {hasBack && (
                    <img
                        ...
                        src={product.product_image_back}
...
export default function ShopCatalog() {
    ...
    return (
        ...
        .na-shop-btn:hover::before { transform: translateX(105%); }
        .na-shop-btn:hover { color: #000000; border-color: #000000; background-color: transparent; }
      `}</style>
