...
// Resolve image src — Supabase URLs are already absolute, don't prepend anything
function imgSrc(src) {
    if (!src) return null;
...
function applySort(products, sort, variantMap) {
    ...
    // Helper: get effective lowest price for a product
...
export default function AllProductCollection() {
    ...
    // Match by collection_id (stored in product.product_collection) OR collection_title as fallback
    const filteredProducts = active.filter(p => {
        if (!collectionData.collection_id) return false;
        return String(p.product_collection) === String(collectionData.collection_id)
            || p.product_collection === collectionData.collection_title;
    });
    ...
    const collectionBgUrl = imgSrc(collectionData.collection_images);
        ...
        <div className="ap-page">
            <style>{`
                ...
                .ap-layout-btn {
                    ...
                    border-radius: 3px; padding: 0; transition: background 0.15s;
                }
                ...
                .ap-sort-btn {
                    ...
                    color: #555; letter-spacing: 0.04em; white-space: nowrap;
                ...
                .ap-sort-option {
                    ...
                    font-family: 'DM Sans', sans-serif; font-size: 12px;
                    color: #555; cursor: pointer; letter-spacing: 0.03em; transition: background 0.1s;
                }
                ...
                .ap-filter-btn {
                    ...
                    background: transparent; border: none; cursor: pointer;
                    font-family: 'DM Sans', sans-serif; font-size: 12px;
                    color: #555; letter-spacing: 0.04em; transition: background 0.15s;
                }
                .ap-filter-btn:hover { background: #fafafa; }
                .ap-filter-panel {
                    position: absolute; top: calc(100% + 1px); right: 0;
                    width: 240px; background: #fff;
                    border: 1px solid #eee; box-shadow: 0 4px 16px rgba(0,0,0,0.07);
                ...
                .ap-img-wrap {
                    ...
                    background: #f9f9f7; overflow: hidden; margin-bottom: 14px;
                }
                .ap-img {
            ...
            <div
                className="ap-header"
                style={collectionBgUrl ? {
                    backgroundImage: `url(${collectionBgUrl})`,
            ...
            >
                ...
                <div style={{ position: "relative", zIndex: 1 }}>
                    <h1 className="ap-title" style={collectionBgUrl ? { color: "#fff" } : {}}>
                        {collectionData.collection_title || "Collection"}
                    </h1>
                    {collectionData.collection_subtitle && (
                        <p style={{
                            fontFamily: "'DM Sans', sans-serif", fontSize: "13px",
                            letterSpacing: "0.18em",
                            color: collectionBgUrl ? "rgba(255,255,255,0.7)" : "#aaa",
                    ...
                    {!loading && !error && (
                        <p className="ap-count" style={collectionBgUrl ? { color: "rgba(255,255,255,0.55)" } : {}}>
            ...
            <div className="ap-grid" data-cols={cols}>
                {loading ? (
                    ...
                    <div className="ap-state">No products found in this collection.</div>
                ) : (
